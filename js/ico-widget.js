    ...
    return (
      <div className="full-width-white">
        <div className="container">
          <div className="row">
            <TokenStatus tokenName="CCE" tokenSupply="80,000,000" tokensDistributed="~800,000" />
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-5 col-md-offset-1">
                ...
                <p>The same Crowdsale Token contract is running on Ethereum Classic and Ethereum.</p>
                <p>We wanted to make participation in the token fundraise as accessible as possible.</p>
    ...
    return (
      <div className="TermsWidget full-width-grey">
        <div className="container">
          <div className="col-md-5 col-md-offset-1">
            <section>
              <h2>Participate in our token fundraise</h2>
              <p>You must accept all the terms and conditions of the Carboncoin Token Fundraise before proceeding. We are only sharing the Token contract details with people who explicitly opt in to the conditions.</p>
            </section>
          </div>
          <div className="col-md-5 col-md-offset-1">
            <section className="terms">
              <p>Please read and accept the following terms to proceed.</p>
              ...
              <p><button className="TermsWidget-proceed btn btn-primary btn-lg" disabled={!(t1 && t2)} onClick={this.acceptTerms}>Proceed to the Fundraise</button></p>
            </section>
          </div>
        </div>
      </div>
          ...
          <div className="row">
            ...
            <section className="instructions col-md-6">
              ...
              <div className="InstructionsWidget-Step">
                ...
                <p>You will need to send some {networkCurrencyName} to our Token contract to get your tokens.</p>
              </div>
              <div className="InstructionsWidget-Step">
                <h5>3. Send {networkCurrencyName} to the Token Contract</h5>
                ...
                <p>When you send the Token Contract some Ether, it will mint your NCC tokens and transfer them to your {networkName} address.</p>
              </div>
              <div className="InstructionsWidget-Step">
